...
function build_stats($input,$num) {
	...
	if ($num == 1) {
		//clean boring words
		$a = preg_split(" ","the of and to a in that it is was i for on you he be with as by at have are this not but had his they from she which or we an there her were one do been all their has would will what if can when so my");
